...
export default function Cards({openModal, stays, onSearch}) {
  ...
  return (
    <div className="w-screen h-screen mt-5 ml-5 mr-10 ">
      <div className="bg-white w-full h-[17%] flex flex-col justify-start items-start md:flex-row md:h-[13%]">
        <div className="h-[50%] mt-4 ml-3 md:mt-8">
          <figure>
            <svg
              width="125"
              height="25"
        ...
        <div className="w-full flex flex-row justify-center items-center md:justify-end md:items-end mr-10">
          <div className="h-full flex flex-row mb-3 md:mt-6 md:mr-7">
            <button className="border-color: text-sm md:text-lg rgba(229, 231, 235, 0.7) border-[1.25px] w-36 bg-white h-14 rounded-xl rounded-r-none" onClick={openModal}>
              {showCity}
            </button>
            <button className="border-color: text-sm md:text-lg rgba(229, 231, 235, 0.7) border-[1.25px] text-[#9CA3AFB3] w-28 bg-white  h-14" onClick={openModal}>
             {showInvitados}
            </button>
            <button className="bg-white text-sm h-14 w-14 rounded-r-2xl border-color: rgba(229, 231, 235, 0.7) border-[1.25px] flex items-center justify-center" onClick={openModal}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
